...
print("\nCarga de maestro de cuentas de tarjetas de credito")
print("------------------------------------")
...
archivo = r'C:\Users\roberto.bravo\Documents\BI\Tarjeta\Maestro\MAESTRO_CUENTAS.txt'
...
with open(archivo, 'r') as f:
    ...
    cursor = cnxn.cursor()
    cursor.execute('TRUNCATE TABLE BP.MAESTRO_CUENTAS')
    ...
    for i, linea in enumerate(datos, start=2):
        ...
        comando = f"INSERT INTO BP.MAESTRO_CUENTAS VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?)"
