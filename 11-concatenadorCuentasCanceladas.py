...
input_folder = r"C:\Users\roberto.bravo\Documents\BI\Tarjeta\Cancelados" + "\\" + MesIni
    # Ruta de la carpeta de salida donde se guardará el archivo concatenado
output_folder = r"C:\Users\roberto.bravo\Documents\BI\Tarjeta\Cancelados"
if not os.path.exists(input_folder):
        print("\nEl directorio {} no existe. No hay más directorios por procesar.".format(input_folder))
        sys.exit()
...
for archivo in os.listdir(input_folder):
    ...
    if archivo.startswith('CONTRATOS_DE_BAJA_') and archivo.endswith('.txt'):
...
with open(os.path.join(output_folder, 'LISTADO_CONTRATOS_DE_BAJA_COMBINADO' + '.txt'), 'w') as f:
        f.write(contenido_final)

print("\n------------------------------------")
print('\nSe ha creado el archivo LISTADO_CONTRATOS_DE_BAJA_COMBINADO' + '.txt')
